...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10412&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sorl-thumbnail-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sorl-thumbnail` can be installed with:

```
conda install sorl-thumbnail
```

It is possible to list all of the versions of `sorl-thumbnail` available on your platform with:
